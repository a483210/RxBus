...
public class RxBusInheritanceDisabledTest {
    ...
    public static class SubscriberExtended extends RxBusInheritanceDisabledTest {
    ...
    static class SubscriberExtendedWithoutNewSubscriberMethod extends RxBusInheritanceDisabledTest {
    }
