...
public class RxBusMultithreadedTest extends AbstractRxBusTest {
    ...
    private void runThreadsSingleEventType(int threadCount) throws InterruptedException {
        ...
        Log.d(RxBus.TAG, threadCount + " threads posted " + iterations + " events each in " + time + "ms");
    ...
    private void runThreadsMixedEventType(int count, int threadCount) throws InterruptedException {
        ...
        Log.d(RxBus.TAG, threadCount * eventTypeCount + " mixed threads posted " + iterations + " events each in "
                + time + "ms");
    ...
    class PosterThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                Log.w(RxBus.TAG, "Unexpeced interrupt", e);
            }
